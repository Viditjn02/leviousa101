...
async function startCapture(screenshotIntervalSeconds = 5, imageQuality = 'medium') {
    ...
    try {
        ...
        // Note: leviousa.e() is not available in this context, commenting out
        // leviousa.e().setStatus('error');
    }
}
...
if (typeof window !== 'undefined') {
    ...
    window.leviousa = window.leviousa || {};
window.leviousa.startCapture = startCapture;
window.leviousa.stopCapture = stopCapture;
} 