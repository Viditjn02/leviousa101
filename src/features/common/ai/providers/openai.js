 ...
 */
function createLLM({ apiKey, model = 'gpt-4o-mini', temperature = 0.7, maxTokens = 2048, usePortkey = false, portkeyVirtualKey, ...config }) {
 ...
 */
function createStreamingLLM({ apiKey, model = 'gpt-4o-mini', temperature = 0.7, maxTokens = 2048, usePortkey = false, portkeyVirtualKey, ...config }) {
  return {
