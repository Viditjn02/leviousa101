...
export const SECURE_DOWNLOAD_URLS: Record<string, SecureDownloadConfig> = {
  'macos-arm64': {
    url: process.env.BLOB_URL_MACOS_ARM64 || 'https://0o5nwpnru4kg7num.public.blob.vercel-storage.com/Leviousa-1.0.11-mac.zip',
    platform: 'macos',
    architecture: 'arm64',
  ...
  'macos-intel': {
    url: process.env.BLOB_URL_MACOS_INTEL || 'https://0o5nwpnru4kg7num.public.blob.vercel-storage.com/Leviousa-1.0.11-mac.zip',
    platform: 'macos', 
    architecture: 'intel',
