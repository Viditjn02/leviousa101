...
class SQLiteClient {
    constructor() {
        this.db = null;
        this.dbPath = null;
        // Remove defaultUserId - no longer needed without local mode
    }
    ...
    initDefaultData() {
        ...
        // Remove default user creation - Firebase authentication only
        ...
        const defaultPresets = [
            ...
            ['customer-support', 'Customer Support', 'You are a customer support assistant. Your goal is to help the user resolve customer issues efficiently and thoroughly.\n\nYou help diagnose customer problems, suggest solutions, provide step-by-step troubleshooting guidance, and ensure customer satisfaction.', 1],
        ];
        ...
        for (const preset of defaultPresets) {
            // Use NULL for uid to make these global template presets
