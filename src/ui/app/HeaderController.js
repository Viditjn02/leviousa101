...
class HeaderTransitionManager {
    ...
    async handleStateUpdate(userState) {
        ...
        if (isConfigured) {
            // If providers are configured and user is authenticated, check permissions
    ...
    async _resizeForMain() {
        ...
        return window.api.headerController.resizeHeaderWindow({ width: 349, height: 47 }).catch(() => {});
    }
